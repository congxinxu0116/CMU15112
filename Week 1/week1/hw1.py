#################################################
# hw1.py
# http://www.kosbie.net/cmu/fall-19/15-112/notes/hw1.html
# Your name: David
# Your andrew id:
#################################################
...
def nearestOdd(n):
    ...
    elif (roundHalfUp(n / 2) >= n/2):
        return roundHalfUp((n / 2)*2 - 1)
    else:
        return roundHalfUp((n / 2)*2 + 1)
...
def isPerfectSquare(n):
    if (type(n) == int and 
        n >= 0 and 
        math.sqrt(n) == roundHalfUp(math.sqrt(n))):
        return True
    return False
